...
def attack(char_name: str, char_class: str) -> str:
    """Высчитывает нанесённый урон разными классами."""
    ...
    return (f'{char_name} не наносил урона противнику')


def defence(char_name: str, char_class: str) -> str:
    """Высчитывает блокированный урон разными классами."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """
    Рассчитывает изменение характеристик персонажа
    при применении специального умения.
    """
    if char_class == 'warrior':
...
def main():
    """Начало игры и приветствие пользователя."""
